...
static void vmbus_force_channel_rescinded(struct vmbus_channel *channel)
{
	 ...
	 * otherwise the state of the hv_sock connections end up in limbo.
	 */
...
static int vmbus_bus_suspend(struct device *dev)
{
	 ...
	 * will thoroughly destroy the channel.
	 */
	...
	list_for_each_entry(channel, &vmbus_connection.chn_list, listentry) {
		/*
		 * Invalidate the field. Upon resume, vmbus_onoffer() will fix up
		 * the field, and the other fields (if necessary).
		 */
